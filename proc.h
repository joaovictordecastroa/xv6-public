...
struct proc {
    ...
    uint ctime;                  // time which the process was created (ticks)
    uint stime;                  // time in SLEEPING state (ticks)
    uint retime;                 // Time in READY(RUNNABLE) state (ticks)
    uint rutime;                 // Time in RUNNING state (ticks)
